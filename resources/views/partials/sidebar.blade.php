        ...
        <ul class="space-y-2 font-medium">
           ...
           <li>
              <a href="/peminjaman" class="flex items-center p-2 text-gray-900 rounded-lg {{ $active === 'peminjaman' ? 'bg-gray-300 text-black' : 'text-gray-900 hover:bg-gray-200' }}">
                 <svg class="flex-shrink-0 w-5 h-5 transition duration-75 {{ $active === 'peminjaman' ? 'text-black' : 'text-gray-500 group-hover:text-black' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
