        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <input 
                        id="nama_pengabiministrasi" 
                        name="nama_pengabiministrasi" 
                        ...
                        type="text" 
                        value="{{ old('nama_pengabiministrasi', session('name', '')) }}" 
                        {{ session('from_google') ? 'readonly' : '' }} 
                        required 
                    />
                    @error('nama_pengabiministrasi')
                ...
                <div class="mt-4">
                    ...
                    >
                        ...
                        <option value="Cabang Utama DKI Jakarta" {{ old('nama_instansi', session('nama_instansi', '')) == 'Cabang Utama DKI Jakarta' ? 'selected' : '' }}>Cabang Utama DKI Jakarta</option>
                        <option value="Cabang Utama Kepulauan Riau" {{ old('nama_instansi', session('nama_instansi', '')) == 'Cabang Utama Kepulauan Riau' ? 'selected' : '' }}>Cabang Utama Kepulauan Riau</option>
                        <option value="Cabang Utama Serang" {{ old('nama_instansi', session('nama_instansi', '')) == 'Cabang Utama Serang' ? 'selected' : '' }}>Cabang Utama Serang</option>
                    </select>
                    @error('nama_instansi')
                        <p class="mt-1 text-red-500 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <div class="mt-4">
                    ...
                    >
                        ...
                        <option value="DKI Jakarta" {{ old('kabupaten_kota', session('kabupaten_kota', '')) == 'DKI Jakarta' ? 'selected' : '' }}>DKI Jakarta</option>
                        <option value="Kepulauan Riau" {{ old('kabupaten_kota', session('kabupaten_kota', '')) == 'Kepulauan Riau' ? 'selected' : '' }}>Kepulauan Riau</option>
                        <option value="Serang" {{ old('kabupaten_kota', session('kabupaten_kota', '')) == 'Serang' ? 'selected' : '' }}>Serang</option>
                    </select>
